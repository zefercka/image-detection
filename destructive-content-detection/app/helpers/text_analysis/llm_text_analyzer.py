...
Важно: классифицируй ТОЛЬКО то, что явно выражено словами в аудио. \
Визуальный контекст — вспомогательная информация для понимания смысла сказанного, \
но не самостоятельное основание для классификации.
"""
